...
switch (_side) do
{
	case west:
	{
		...
		_query = format["UPDATE players SET name='%1', life_cop_cash='%2', life_cop_atmcash='%3', cop_gear='%4', cop_licenses='%5' WHERE playerid='%6'",_name,_money,_bank,_misc,_licenses,_uid];
	};
	...
	case civilian:
	{
		...
		_query = format["UPDATE players SET name='%1', life_cash='%2', life_atmcash='%3', civ_licenses='%4', civ_gear='%6', arrested='%7' WHERE playerid='%5'",
